...
<div class="container-fluid flyer-builder">
    ...
    <div class="row">
        <div class="col-sm-6 loc_form">
            ...
            <div class="form-group">
                <label for="flyer-title" class="control-label">Title2</label>
                <input required class="form-control" id="flyer-title2" placeholder="Main title" value="Really incredible!!" maxlength="255" type="text" tabindex="2">
            </div>
            <div class="form-group">
                <label class="control-label" for="flyer-description">Description</label>
                <textarea class="form-control" id="flyer-description" placeholder="Insert a short description taking care of the available space">Lorem ipsum dolor sit ametrallon</textarea>
            </div>

            <div class="form-group">
                <label class="control-label" for="flyer-description2">Description2</label>
                <textarea class="form-control" id="flyer-description2" placeholder="Prova">Prova</textarea>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="flyer-price" class="control-label">Price</label>
                        <input required class="form-control" id="flyer-price2" placeholder="Enter price (w/o decimals)" value="100" type="number" tabindex="5" step="any" min="0">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label for="flyer-price-currency2" class="control-label">Currency</label>
...
{{--<script type="text/javascript" src="http://www.primominuto.net/articoli/pdf_flyer/flyer_builder.js"></script>--}}
<script>
        ...
        try {
            ...
            var createPDF = function (update_preview) {
                ...
                if(flyer_description) {
                    ...
                    var description2_lines = pdf.splitTextToSize(flyer_description2, lineWidth);
                    ...
                    for (var i = 0 ; i < description2_lines.length ; i++ ) {
                        pdf.text(page_margin, _y, description2_lines[i]+"------------------------ " +"€");
                        _y += line_height;
                    }
